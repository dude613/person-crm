import { getAllPersons } from "src/actions/person";
import HomePage from "src/components/dashboard/persons/HomePage";
import PersonCard from "src/components/dashboard/persons/PersonCard";
